...
**Focus:** Recipe-detail redesign challenge — produce an independent concept (v4) that either improves meaningfully on v3 or argues honestly why v3 is already right. Outcome: built v4 "The Pass" — keeps v3's strong bones, fixes four real weaknesses, recipe-generic for all food types now and future.
