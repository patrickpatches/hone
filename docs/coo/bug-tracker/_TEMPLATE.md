...
**Screenshot:** drop the image into `docs/coo/bug-tracker/screenshots/HONE-NNN-<short-tag>.png` and reference here. If it's a video/GIF, same folder.
...
- Observation: …
- If PARTIAL: describe the side-effect; li