...
const THAI_GREEN_CURRY: Recipe = {
  ...
  ingredients: [
    ...
    { id: 'i7', name: 'Makrut lime leaves', amount: 4, unit: '', scales: 'fixed',
      substitutions: [
        { ingredient: 'Lime zest, freshly grated', changes: 'Provides citrus brightness without the distinctive floral-herbal complexity of makrut lime. The broth will be simpler but still fragrant.', quality: 'red', quantity_note: 'use zest of 1 lime per 4 makrut lime leaves', hard_to_find: true, local_alternative: 'Available frozen at most Asian grocers, Harris Farm Markets, and some Woolworths stores. Worth having in the freezer.' },
      ],
    },
    ...
    { id: 'i10', name: 'Chicken stock', amount: 300, unit: 'ml', scales: 'linear',
      substitutions: [
        { ingredient: 'Vegetable stock', changes: 'Works well for a lighter or vegetarian version. Use a good-quality stock — it forms part of the sauce body.', quality: 'green' },
        { ingredient: 'Water', changes: 'The sauce will be less complex but still works. Add an extra splash of fish sauce to compensate for lost depth.', quality: 'yellow' },
      ],
    },
    { id: 'i11', name: 'Lime', amount: 2, unit: '', scales: 'fixed',
      substitutions: [
        { ingredient: 'Lemon juice', changes: 'Sharper and less floral than lime. Use half the quantity and taste — lemon is more assertive in a Thai broth.', quality: 'yellow', quantity_note: 'juice of 1 lemon in place of 2 limes' },
      ],
    },
  ],
  steps: [
    ...
    { id: 's4', title: 'Add coconut milk, stock and simmer', content: 'Pour in the rest of the coconut milk, the thin liquid from the can, and the chicken stock. Add makrut lime leaves, fish sauce, sugar, vegetables. Simmer 12 minutes.', timer_seconds: 720, why_note: 'The stock doubles the sauce volume so there\'s enough to dress four bowls of rice. The balance of fish sauce (salt + umami), sugar (sweetness), and lime leaf (citrus-floral) is the holy trinity of Thai cooking. Taste and adjust — the exact amounts depend on your brand of paste and fish sauce.' },
    { id: 's5', title: 'Finish with basil and lime', content: "Remove from heat. Stir in Thai basil leaves — they'll wilt from the residual heat. Squeeze in the juice of both limes and taste. Serve with jasmine rice.", why_note: 'Thai basil loses its anise-clove aroma with prolonged heat — adding off heat preserves the volatile compounds. The lime juice is a core seasoning here, not a garnish. Andy Cooks finishes with 2 limes; taste and adjust to your batch of paste and fish sauce.' },
  ],
  ...
  mise_en_place: [
    ...
    "Tear makrut lime leaves slightly to release their oils (leave whole — remove before eating)",
    "Have Thai basil ready, leaves picked",
    "Cut limes in half, ready to squeeze at the end",
    "Start jasmine rice now — it takes 12–15 minutes and should be ready when the curry finishes",
  ],
  finishing_note: "Taste before serving: Thai cooking is built on the balance of salty (fish sauce), sweet (palm sugar), sour (lime), and aromatic (makrut lime, basil). These need to be in harmony — no single element should dominate. Squeeze both limes in now as a core seasoning. A little extra fish sauce if it needs salt. If it's too spicy, a teaspoon more palm sugar softens the heat. Serve in deep bowls over jasmine rice.",
...
const PAD_THAI: Recipe = {
  ...
  ingredients: [
    ...
    {
      id: 'i6', name: 'Palm sugar', amount: 2, unit: 'tbsp', scales: 'fixed',
      substitutions: [
    ...
    { id: 'i11', name: 'Garlic', amount: 2, unit: 'cloves', scales: 'fixed', prep: 'Finely sliced or minced' },
    { id: 'i12', name: 'Shallot', amount: 1, unit: '', scales: 'fixed', prep: 'Finely sliced' },
  ],
  steps: [
    { id: 's1', title: 'Soak noodles, mix sauce', content: 'Soak noodles in cold water 20 minutes until pliable but not cooked. Mix tamarind, fish sauce, sugar — taste it. Sweet-sour leads, then salty — that\'s the authentic balance. Adjust now, not mid-cook.', timer_seconds: 1200, why_note: 'Cold soak (not boiling) means the noodles still have structural integrity when they hit the wok. Boiled noodles finish as mush. The sauce ratio defines pad Thai — get it right off the heat where you can taste clearly.' },
    ...
    { id: 's3', title: 'Protein, aromatics, then egg', content: 'Add protein to the wok edge, cook 2 minutes. Push to the side. Add garlic and shallot into the hot oil — fry 30 seconds until fragrant. Push aside with the protein. Crack eggs into the hot centre, scramble until almost set, then push to the side.', timer_seconds: 120, why_note: 'Frying garlic and shallot after the protein is the step that makes restaurant pad Thai taste different from home pad Thai. No professional version skips aromatics — they build the base flavour that the noodles absorb. Thirty seconds only: past that they burn and turn bitter.' },
  ...
  before_you_start: [
    ...
    "The sauce ratio is the dish. Mix tamarind, fish sauce, and palm sugar before the wok goes on and taste it cold — sweet-sour leads, then salty. That's the authentic balance (per Pailin Chongchitnant, the benchmark for this dish). Adjust now, not mid-cook.",
  ...
  mise_en_place: [
    ...
    "Finely slice the garlic and shallot — these go in after the protein",
...
const WEEKDAY_BOLOGNESE: Recipe = {
  ...
  source: {
    chef: 'Tucker & Spice Kitchen',
    notes: "Milk-first weekday adaptation after Marcella Hazan's method from *Essentials of Classic Italian Cooking* (1992). Soffritto built properly, milk before wine, patience with the brown bits.",
  },
  emoji: '🍝',
...
const CHICKEN_SHAWARMA: Recipe = {
  ...
  steps: [
    ...
    },
    {
      ...
      timer_seconds: 1380,
      stage_note: 'Internal 80–85 °C at the thickest part (74 °C is the safety minimum — thighs eat better higher). Edges dark golden-brown to lightly charred.',
      lookahead: 'You\'re going to finish under the grill for 2–3 minutes — keep an eye on it the moment that switches on.',
    ...
    {
      id: 's3', title: 'Finish under the grill (2–3 min)',
      content: 'Switch the oven to grill on high. Watch the chicken constantly. You want char marks on the edges — not blackened all over, but definitely darker than golden.',
      timer_seconds: 150,
  ...
  before_you_start: [
    ...
    "You need colour on the chicken. Pale, steamed-looking shawarma is wrong. The oven must be at 220 °C (fan-forced) and the tray must not be overcrowded — pieces touching means they steam instead of roast. A final 2–3 minutes under the grill gets the char marks that make it taste right.",
